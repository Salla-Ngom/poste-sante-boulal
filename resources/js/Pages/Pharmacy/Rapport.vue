...
<template>
    ...
    <Head title="Rapport pharmacie - PS Boulal" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Rapport de clôture pharmacie
            </h2>
        </template>
            ...
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
                ...
                <div class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-6 text-white shadow-lg">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold mb-1">Caisse pharmacie clôturée</h1>
                            <p class="text-purple-100">Le rapport PDF a été généré et archivé</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    ...
                    <div class="p-5 space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600 text-sm">Pharmacien</span>
                ...
                <div class="bg-white rounded-2xl border-2 border-purple-200 shadow-sm p-6">
                    <div class="flex items-start gap-4 mb-4">
                        <div class="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center text-purple-600 font-bold text-xl">
                            PDF
                        </div>
                        <div class="flex-1">
                    ...
                    <a :href="route('pharmacy.caisse.rapport.telecharger', session.id)"
                        class="block w-full px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white text-center rounded-lg font-semibold shadow-lg shadow-purple-200 transition">
